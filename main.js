...
let cart = [];
let buttonsDOM = [];
//'https://shopeeapi2.p.rapidapi.com/id/seller/179967476/products/11043778'
//https://61afbc6c3e2aba0017c494ef.mockapi.io/products
class Products {
  async getProducts() {
    try {
      let result = await fetch(
        'https://651ebe3344a3a8aa4768ea84.mockapi.io/products'
      );
